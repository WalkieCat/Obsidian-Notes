**What is SOC**:
- Facility that houses a team of information security experts responsible for continuous monitoring and evaluation of an org security status
- Main obj: identify, examine, address cybersecurity incidents
- SOC uses tools like Security Incident and Event Management (SIEM), Intrusion Detection System/Prevention System (IDS/IPS) and Endpoint Detection and Response (EDR)
- SOC encompasses incident triage, containment, elimination and recovery; they works closely with incident response team 

**How does SOC works**:
- Manage ongoing operational aspect of enterprise information security, consists of security analysts who detects, assess, respond to, report on and prevent cybersecurity incidents
- Some SOCs might possesses advanced capabilities like forensic and malware analysis
